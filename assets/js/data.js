...
app.data.new_year.cards = ['funny', 'lily', 'flowers', 'hearts', 'seattle', 'castle', 'success', 'biblical', 'sunset', 'earth', 'sydney', 'chalk']

app.data.new_year.meta = {
  title: 'Happy New Year'
, keywords: 'cards, free, new year'
